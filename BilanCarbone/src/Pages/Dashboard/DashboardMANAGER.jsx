...
<main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-1">
        ...
        <Chart_dash_NA nomEntreprise={nomEntreprise} idEntreprise={idEntreprise} />
        <Chart_circle_NA idEntreprise={idEntreprise}/>
        </div>
        ) : (
              ...
              <Table>
                ...
                <TableBody>
                    {user.map(u=>{
                        ...
                        return(
                            <TableRow key={u.customUserRepresentation.userRepresentation.username}>
                            <TableCell>
